/*
* In the 20×20 grid below, four numbers along a diagonal line at
* (8,6),(9,7),(10,8),(11,9)
*
...
var largestProductOfFour = function(matrix) {
  ...
  var length = 4;
  // This give us the first n.
  for(var i = 0; i < matrix.length; i++){
    // This gives us the second n.
    for(var j = 0; j < matrix[0].length; j++){

      // forward or backward
      // You might be tempted to count this, but remember this is only going to four not n.
      // So in here we have something like 9 * 4 or 36 operations. But this just comes down to
      // a constant so we fold it into the n^2.
      ...
      // diagonal-up-back diagonal and diagonal-down-forward
      currentMultiple = 1;
      for(var k = 0; k < length; k++){
        if(i-k > 0 && j-k > 0){
      ...
      // diagonal-up-forward and diagonal-down-backward
      currentMultiple = 1;
      for(var k = 0; k < length; k++){
...
console.log(largestProductOfFour(matrix));
