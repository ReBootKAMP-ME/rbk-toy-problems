...
Tree.prototype.countLeaves = function (root ,nodeLeft , noderight) {
  //we check of both children of the node is null , if yes we return 1 ;
  ...
  if( nodeLeft === null && noderight === null ) {
    ...
    var result = countLeaves(nodeLeft) + countLeaves(noderight);
  }
  return result ;
}
